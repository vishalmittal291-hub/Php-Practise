<nav class="bg-gray-800/50">
        ...
        <div class="hidden md:block">
          <div class="ml-4 flex items-center md:ml-6">
            ...
            <div class="relative ml-3">
              ...
              <div
                id="user-menu"
                class="dropdown-menu absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-gray-800 py-1 outline-1 -outline-offset-1 outline-white/10"
              >
                <a
                  href="#"
    ...
    <div id="mobile-menu" class="hidden md:hidden">
      <div class="space-y-1 px-2 pt-2 pb-3 sm:px-3">
        <a href="/practise/index.php" class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white">Home</a>
        <a href="/practise/about.php" aria-current="page" class="bg-gray-950/50 text-white rounded-md px-3 py-2 text-sm font-medium">About</a>
        <a href="/practise/contact.php" class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white">Contact</a>
      </div>
